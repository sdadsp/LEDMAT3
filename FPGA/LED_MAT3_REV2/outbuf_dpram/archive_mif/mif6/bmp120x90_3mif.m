...
src_img = imread('input120x90.bmp');
...
for r = 1:rows3
    for c = 1:cols_std
        red = uint32(src_img_120x90(r,c,1));
        green = uint32(src_img_120x90(r,c,2));
        blue = uint32(src_img_120x90(r,c,3));
