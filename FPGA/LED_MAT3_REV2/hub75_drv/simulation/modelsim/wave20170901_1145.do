...
add wave -noupdate /hub75_drv_vlg_tst/HUB_ADDR
add wave -noupdate /hub75_drv_vlg_tst/HUB_R
add wave -noupdate /hub75_drv_vlg_tst/HUB_G
add wave -noupdate /hub75_drv_vlg_tst/HUB_B
add wave -noupdate /hub75_drv_vlg_tst/MEM_ADDR
...
WaveRestoreCursors {{Cursor 1} {15721116 ps} 0} {{Cursor 2} {1021873 ps} 0}
...
update
WaveRestoreZoom {0 ps} {24797440 ps}
