...
add wave -noupdate -radix hexadecimal /mbi5153_ctrl_tb/mbi5153_ctrl_inst/fsm_led_drv
add wave -noupdate -radix hexadecimal -childformat {{{/mbi5153_ctrl_tb/mbi5153_ctrl_inst/dclk_cnt[1]} -radix hexadecimal} {{/mbi5153_ctrl_tb/mbi5153_ctrl_inst/dclk_cnt[0]} -radix hexadecimal}} -subitemconfig {{/mbi5153_ctrl_tb/mbi5153_ctrl_inst/dclk_cnt[1]} {-radix hexadecimal} {/mbi5153_ctrl_tb/mbi5153_ctrl_inst/dclk_cnt[0]} {-radix hexadecimal}} /mbi5153_ctrl_tb/mbi5153_ctrl_inst/dclk_cnt
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {19046620 ps} 0}
...
update
WaveRestoreZoom {2705500 ps} {41081320 ps}
