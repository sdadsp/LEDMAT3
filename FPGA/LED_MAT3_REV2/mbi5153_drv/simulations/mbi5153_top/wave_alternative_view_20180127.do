...
add wave -noupdate -color {Pale Green} -height 32 /mbi5153_top_tb/HUB75_GCLK
add wave -noupdate -label GCLK_COUNTER -radix unsigned /mbi5153_top_tb/mbi5153_top_inst/mbi5153_gclk_inst/pwm_cycle_cnt
add wave -noupdate -label SCAN_LINE_NUMBER -radix hexadecimal /mbi5153_top_tb/HUB75_ADDR
add wave -noupdate -height 32 /mbi5153_top_tb/HUB75_CLK
add wave -noupdate -color Salmon -height 32 /mbi5153_top_tb/HUB75_LATCH
...
WaveRestoreCursors {{Cursor 3} {3537228870 ps} 0}
...
update
WaveRestoreZoom {3530016190 ps} {3540984370 ps}
